...
import AeroRobot.modules.sql.global_bans_sql as gban_sql
import AeroRobot.modules.sql.users_sql as user_sql
from AeroRobot import DEV_USERS, OWNER_ID, dispatcher
