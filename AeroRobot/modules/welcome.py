...
import AeroRobot.modules.sql.welcome_sql as sql
from AeroRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from AeroRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from AeroRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from AeroRobot.modules.helper_funcs.msg_types import get_welcome_type
from AeroRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from AeroRobot.modules.log_channel import loggable
from AeroRobot.modules.sql.global_bans_sql import is_user_gbanned
...
AERODYNAMIC_IMG = "https://telegra.ph/file/e321b823276a3c54c1dce.mp4"
AERODYNAMIC = "https://telegra.ph/file/be5388d1c407d5fe0ca14.jpg"
AERODYNAMIC_VID = "https://telegra.ph/file/cf5a6cad607d0172809cf.mp4"
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                AERODYNAMIC_IMG, caption= "Oh, Genos? Let's get this moving.",
                    reply_to_message_id=reply)
            ...
            # Welcome Sudos
                ...
                AERODYNAMIC, caption= "Huh! A Rank Hunter just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_photo(
                AERODYNAMIC, caption= "Huh! Someone with a B Rank Hunter level just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_photo(
                AERODYNAMIC, caption= "Oof! A C Rank Hunter just joined!",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_photo(
                AERODYNAMIC, caption= "Oof! A D Rank Hunter just joined!",
                    reply_to_message_id=reply)
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_video(
                AERODYNAMIC_VID, caption= "Oi! Genos! He left..", reply_to_message_id=reply)
                return
