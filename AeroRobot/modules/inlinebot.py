...
from AeroRobot.modules.sudoers import bot_sys_stats as wall
...
from AeroRobot.modules.helper_funcs.miku_misc import article
from AeroRobot.modules.helper_funcs.decorators import kiginline
...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Account info on Aerodynamic",
        ...
        {
            "title": "About",
            "description": "Know about Aerodynamic",
