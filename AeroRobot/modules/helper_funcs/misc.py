    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 6 : 6 * (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("Close", callback_data="aerodynamic_back"),
                EqInlineKeyboardButton(
        ...
        pairs += [[EqInlineKeyboardButton("Close", callback_data="aerodynamic_back")]]
