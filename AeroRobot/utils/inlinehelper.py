...
from AeroRobot import OWNER_ID, pgram, arq
from AeroRobot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from AeroRobot.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("More Help", url=f"t.me/Aero_Management_Bot?start=start"),
...
async def alive_function(answers):
   ...
   # ubot_state = 'Dead' if not await app2.get_me() else 'Alive'
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/Aero_Management_Bot"),
        InlineKeyboardButton("Go Inline", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Aerodynamic 💜](https://t.me/Aero_Management_Bot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
**Platform:** `{sys.platform}`
**Profiles:** [BOT](t.me/Aero_Management_Bot) | [OWNER](t.me/Awesome_Prince)
"""
